...
public class LoadingView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.LoadingView_loading_size, dp2px(context, 32));
        mPaintColor = array.getColor(R.styleable.LoadingView_loading_color, Color.WHITE);
        array.recycle();
    }
